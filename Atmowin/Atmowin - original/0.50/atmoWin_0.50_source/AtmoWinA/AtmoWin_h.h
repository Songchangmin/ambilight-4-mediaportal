...
/* interface __MIDL_itf_AtmoWin_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_AtmoWin_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_AtmoWin_0000_v0_0_s_ifspec;
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl_setEffect_Proxy( 
    IAtmoRemoteControl * This,
    /* [in] */ enum ComEffectMode dwEffect,
    /* [out] */ enum ComEffectMode *dwOldEffect);


void __RPC_STUB IAtmoRemoteControl_setEffect_Stub(
    IRpcStubBuffer *This,
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl_getEffect_Proxy( 
    IAtmoRemoteControl * This,
    /* [in] */ enum ComEffectMode *dwEffect);


void __RPC_STUB IAtmoRemoteControl_getEffect_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl_setStaticColor_Proxy( 
    IAtmoRemoteControl * This,
    /* [in] */ BYTE red,
    /* [in] */ BYTE green,
    /* [in] */ BYTE blue);
...
void __RPC_STUB IAtmoRemoteControl_setStaticColor_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl_setChannelStaticColor_Proxy( 
    IAtmoRemoteControl * This,
    /* [in] */ INT channel,
    /* [in] */ BYTE red,
    /* [in] */ BYTE green,
...
void __RPC_STUB IAtmoRemoteControl_setChannelStaticColor_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl_setChannelValues_Proxy( 
    IAtmoRemoteControl * This,
    /* [in] */ SAFEARRAY * channel_values);


void __RPC_STUB IAtmoRemoteControl_setChannelValues_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoRemoteControl2_getLiveViewRes_Proxy( 
    IAtmoRemoteControl2 * This,
    /* [out] */ int *Width,
    /* [out] */ int *Height);


void __RPC_STUB IAtmoRemoteControl2_getLiveViewRes_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoLiveViewControl_setLiveViewSource_Proxy( 
    IAtmoLiveViewControl * This,
    /* [in] */ enum ComLiveViewSource dwModus);


void __RPC_STUB IAtmoLiveViewControl_setLiveViewSource_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoLiveViewControl_getCurrentLiveViewSource_Proxy( 
    IAtmoLiveViewControl * This,
    /* [out] */ enum ComLiveViewSource *modus);


void __RPC_STUB IAtmoLiveViewControl_getCurrentLiveViewSource_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IAtmoLiveViewControl_setPixelData_Proxy( 
    IAtmoLiveViewControl * This,
    /* [in] */ SAFEARRAY * bitmapInfoHeader,
    /* [in] */ SAFEARRAY * pixelData);


void __RPC_STUB IAtmoLiveViewControl_setPixelData_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
