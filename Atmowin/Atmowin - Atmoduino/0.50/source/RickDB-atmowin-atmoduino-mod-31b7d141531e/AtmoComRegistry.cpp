...
void __stdcall OaEnablePerUserTLibRegistration(void);
...
*/
    if(typeLib)
    {
       ...
       if(res == TYPE_E_REGISTRYACCESS)
       {
          ...
          if(oleaut32 != 0)
          {
			...
			//oaEnablePerUserTLibRegistration = (OaEnablePerUserTLibRegistration )GetProcAddress(oleaut32, "OaEnablePerUserTLibRegistration");
 ...
 void CAtmoComRegistry::DeleteSettings() {
