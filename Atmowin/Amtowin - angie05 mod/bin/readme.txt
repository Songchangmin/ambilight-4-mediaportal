...
- Zone Overlap gives in some cases a more detailed lightshow^^ (0=max Detail, 3=default)
- Filter length adjustable level increased (smaller filter length)
- Gamma correction is more precisely adjustable (another digit^^)

!!! RGB Calibration table is not working yet !!!



<----------Standard AtmoWIn Readmetext----------->
